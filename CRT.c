...
int CRT_colorSchemes[LAST_COLORSCHEME][LAST_COLORELEMENT] = {
   [COLORSCHEME_DEFAULT] = {
      ...
      [TEMPERATURE_COOL] = A_BOLD | ColorPair(Green,Black),
      [TEMPERATURE_MEDIUM] = A_BOLD | ColorPair(Yellow,Black),
   ...
   [COLORSCHEME_BLACKONWHITE] = {
      ...
      [TEMPERATURE_HOT] = A_BOLD | ColorPair(Red,White),
   ...
   [COLORSCHEME_MIDNIGHT] = {
      ...
      [TEMPERATURE_COOL] = ColorPair(Green,Blue),
      [TEMPERATURE_MEDIUM] = ColorPair(Yellow,Blue),
   ...
   [COLORSCHEME_BLACKNIGHT] = {
      ...
      [LED_COLOR] = ColorPair(Green,Black),
      [TASKS_RUNNING] = A_BOLD | ColorPair(Green,Black),
      [TEMPERATURE_COOL] = ColorPair(Cyan,Black),
      [TEMPERATURE_MEDIUM] = ColorPair(Yellow,Black),
      [TEMPERATURE_HOT] = A_BOLD | ColorPair(Red,Black),
